...
import { ExclusiveHotKeyMode, InputService } from '../../services/input.service';
...
export class MainWindowController {
  ...
  constructor(
    ...
    private readonly overlayHotkeysService: HotkeysService,
    private readonly overlayInputService: InputService
  ) {
    this.registerToIpc();
